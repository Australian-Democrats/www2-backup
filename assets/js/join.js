(function(){
  ...
  function selectTier(v){
    ...
    // state.autoRenew is owned by the renew buttons only — never forced here. Forcing it
    // false for Supporter (and never restoring it) sent autoRenew=false for a member who
    // picked Supporter first and then a paid tier, while the buttons still showed
    // "Seamless auto-renew" pressed: a one-off charge behind an auto-renew UI (23 of 39
    // website paid joins Jul–Sep 2026 were one-off). The payload masks it for Supporter.
